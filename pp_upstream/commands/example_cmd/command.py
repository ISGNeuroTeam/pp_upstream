...
class ExampleCmdCommand(BaseCommand):
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        self.log_progress('Start example_cmd command')
        ...
        self.logger.debug(f'Command example_cmd get first positional argument = {first_positional_string_argument}')
        self.logger.debug(f'Command example_cmd get keyword argument = {kwarg_int_argument}')
